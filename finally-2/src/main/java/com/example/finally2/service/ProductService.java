...
public class ProductService {
    ...
    public Page<ProductResponse> getProducts(String productCode, String productName, LocalDate startCreate, LocalDate endCreate, Pageable pageable) {
        Page<Product> products = productRepository.finAllProduct(ProductStatus.ACTIVE,
                ...
                endCreate,
                pageable);
        return products.map(productMapperResponse::toDTO);
    }
